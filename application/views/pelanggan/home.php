                ...
                <tbody>
                    ...
                    foreach ($keluhan as $a) : ?>
                        <tr class="text-center">
                            ...
                            <?php if ($a['status'] == 'Ditinjau' && $a['status_pesan'] == 'bidang') {
                                echo 'btn-primary';
                            } else if ($a['status'] == 'Ditolak') {
                                echo 'btn-danger';
                            } else if ($a['status'] == 'Ditinjau' && $a['status_pesan'] == 'pelanggan') {
                                echo 'btn-success';
                            } else {
                                echo 'btn-success';
                            }; ?>">
                                    <i class="bx <?php
                                                    if ($a['status'] == 'Ditinjau' && $a['status_pesan'] == 'bidang') {
                                                        echo 'bx-message-error';
                                                    } else if ($a['status'] == 'Ditolak') {
                                                        echo 'bx-message-error';
                                                    } else if ($a['status'] == 'Ditinjau' && $a['status_pesan'] == 'pelanggan') {
                                                        echo 'bx-message-x';
                                    ...
                                    </i> <?php if ($a['status'] == 'Ditinjau' && $a['status_pesan'] == 'bidang') {
                                                echo 'Balas';
                                            } else if ($a['status'] == 'Ditolak') {
                                                echo 'Benahi';
                                            } else if ($a['status'] == 'Ditinjau' && $a['status_pesan'] == 'pelanggan') {
